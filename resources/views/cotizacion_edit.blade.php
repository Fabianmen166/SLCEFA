                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="customers_id" name="customers_id" required>
                                    ...
                                    @foreach ($customers as $customer)
                                        <option value="{{ $customer->customers_id }}" {{ $customer->customers_id == $quote->customers_id ? 'selected' : '' }}>
                                    ...
                                    <div class="service-row mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 d-flex align-items-end">
                                                <button type="button" class="btn btn-danger remove-service-btn" style="display: {{ $index == 0 && $quote->services->count() == 1 ? 'none' : 'block' }};">Eliminar</button>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
