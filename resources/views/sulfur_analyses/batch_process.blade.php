...
@section('title', 'Procesar Análisis de Azufre (Lote)')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @if ($pendingAnalyses->isEmpty())
                ...
                <a href="{{ route('sulfur_analysis.index') }}" class="btn btn-secondary">Regresar</a>
            @else
                ...
                <form action="{{ route('sulfur_analysis.store_batch_process') }}" method="POST" id="sulfurBatchForm">
                    @csrf
                                ...
                                <tbody>
                                    @foreach ($pendingAnalyses as $analysis)
                                        <tr>
                                            ...
                                            <td><input type="number" step="any" class="form-control" name="items_ensayo[{{$loop->index}}][sulfur_disponible_mg_l]"></td>
                                            <td><input type="number" step="any" class="form-control" name="items_ensayo[{{$loop->index}}][sulfur_disponible_mg_kg]" readonly></td>
