                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @forelse($processes as $process)
                                    <tr>
                                        <td>
                                            <input type="checkbox" class="process-checkbox" value="{{ $process->process_id }}">
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('phosphorus_analysis.phosphorus_analysis', [$process->process_id, $process->analyses->first()->service_id]) }}" 
