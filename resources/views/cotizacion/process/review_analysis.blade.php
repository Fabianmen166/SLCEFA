<!-- resources/views/process/review_analysis.blade.php -->
@extends('Layouts.master1')

@section('title', 'Revisar Análisis')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Revisar Análisis</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Inicio</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('process.review_index') }}">Revisar Análisis</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p><strong>Detalles:</strong> {{ $analysis->details ?? 'Sin detalles' }}</p>
                <!-- Formulario para revisar el análisis -->
                <form action="{{ route('process.store_review', $analysis->id) }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="review_details">Comentarios de Revisión</label>
                        <textarea name="review_details" class="form-control" rows="3"></textarea>
                    </div>
                    <div class="form-group">
