    ...
    public function storeHumidityAnalysis(Request $request, $processId, $serviceId)
{
    try {
        ...
        $validated = $request->validate([
            ...
            'codigo_interno.regex' => 'El código interno solo puede contener letras, números y guiones.',
            'peso_capsula.numeric' => 'El peso de la cápsula debe ser un número.',
            'peso_muestra.numeric' => 'El peso de la muestra debe ser un número.',
            'peso_capsula_muestra_humedad.numeric' => 'El peso de la cápsula con muestra húmeda debe ser un número.',
            'peso_capsula_muestra_seca.numeric' => 'El peso de la cápsula con muestra seca debe ser un número.',
            'porcentaje_humedad.numeric' => 'El porcentaje de humedad debe ser un número.',
        ]);
