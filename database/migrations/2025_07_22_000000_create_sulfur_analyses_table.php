...
return new class extends Migration {
    public function up()
    {
        Schema::create('sulfur_analyses', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('sulfur_disponible_mg_l', 10, 4)->nullable();
            $table->decimal('sulfur_disponible_mg_kg', 10, 4)->nullable();
    ...
    {
        Schema::dropIfExists('sulfur_analyses');
    }
}; 